...
class Berichten extends OpdrachtenController
{
	...
	public function _overzicht()
	{
		...
		$pagina['pagina'] = 'opdrachten/berichten';
	...
	public function bericht($item_ID = null)
	{
		...
		if($item_ID == null) redirect('opdrachten/berichten');
		...
		$pagina['data'] = $this->data;
		$pagina['pagina'] = 'opdrachten/berichten_bericht';
		$this->load->view('opdrachten/template', $pagina);
	}
	...
	private function _opstellen($item_ID = null)
	{
		...
		else
		{
			...
			if(!$bericht->bericht_no_reply) {
                // Controleren of het bericht voor de huidige gebruiker bedoeld is

                if ($bericht->bericht_ontvanger_ID == $this->session->userdata('gebruiker_ID')) {
		...
		$pagina['data'] = $this->data;
		$pagina['pagina'] = 'opdrachten/berichten_nieuw';
		$this->load->view('opdrachten/template', $pagina);
	}
	...
	public function verwijderen($item_ID = null, $actie = null)
	{
        ...
        if($bericht == null || $bericht->bericht_ontvanger_ID != $this->session->userdata('gebruiker_ID') && $bericht->bericht_afzender_ID != $this->session->userdata('gebruiker_ID')) redirect('opdrachten/berichten');
		...
		$pagina['data'] = $this->data;
		$pagina['pagina'] = 'opdrachten/berichten_verwijderen';
		$this->load->view('opdrachten/template', $pagina);
	}
