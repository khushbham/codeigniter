	...
	<div id="buttons">
		<p>
            <?php if(!$bericht->bericht_no_reply) { ?>
			    <a href="<?php echo base_url('cursistenmodule/berichten/beantwoorden/'.$bericht->bericht_ID) ?>" title="Bericht beantwoorden" class="belangrijk">Beantwoorden</a>
            <?php } ?>
			<a href="<?php echo base_url('cursistenmodule/berichten') ?>" title="Annuleren">Annuleren</a>
			<a href="<?php echo base_url('cursistenmodule/berichten/verwijderen/'.$bericht->bericht_ID.'/bericht') ?>" title="Bericht verwijderen">Verwijderen</a>
		</p>
	</div>
	<div id="bericht">
