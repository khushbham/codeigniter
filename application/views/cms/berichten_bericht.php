<div id="berichten">
	...
	<div id="buttons">
		<p>
        <?php if ($bericht->bericht_ontvanger_ID == $this->session->userdata('beheerder_ID')) { ?>
			<a href="<?php echo base_url('cms/berichten/beantwoorden/'.$bericht->bericht_ID) ?>" title="Bericht beantwoorden" class="belangrijk">Beantwoorden</a>
            <a href="<?php echo base_url('cms/berichten/doorsturen/'.$bericht->bericht_ID) ?>" title="Bericht doorsturen" class="belangrijk">Doorsturen</a>
        <?php } ?>
			<a href="<?php echo base_url('cms/berichten') ?>" title="Annuleren">Annuleren</a>
			<a href="<?php echo base_url('cms/berichten/verwijderen/'.$bericht->bericht_ID.'/bericht') ?>" title="Bericht verwijderen">Verwijderen</a>
		</p>
	</div>
	<div id="bericht">
