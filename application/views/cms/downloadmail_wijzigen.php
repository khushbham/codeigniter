<h1>Download link mail wijzigen</h1>
<div id="toevoegen_wijzigen" class="formulier">
    <form method="post" action="<?php echo base_url('cms/'. $actie .'/downloadlink_mail/'.$item_ID); ?>">
        <p><label for="item_groep">Groep</label><?php echo $groep_naam ?></p>
        ...
        <div id="media">
            ...
            <div id="media_container">
                ...
                <div id="media_acties">
                    <p><a href="#koppelen" title="Media koppelen aan downloadlink mail" class="koppelen" data-soort="media" data-welkomstmail="true">Media koppelen</a> | <a href="<?php echo base_url('cms/media/toevoegen') ?>" title="Media toevoegen aan mediabibliotheek (opent een nieuw tabblad / venster)" target="_blank">Media toevoegen</a></p>
                    <input type="hidden" name="item_media" id="item_media" value="<?php echo $item_media ?>" data-aantal="0" />
                </div>
            </div>
        </div>
        <p class="submit"><input type="submit" value="Mail wijzigen" /><a href="<?php echo base_url('cms/'. $actie .'/wijzigen/'.$item_ID) ?>" title="Annuleren">Annuleren</a></p>
    </form>
</div>