<h1>Docent <?php echo $actie ?></h1>
<div id="toevoegen_wijzigen" class="formulier">
	<form method="post" action="<?php if($actie == 'toevoegen') echo base_url('cms/docenten/toevoegen/'); else echo base_url('cms/docenten/wijzigen/'.$item_ID); ?>">
		<p>
			<label for="item_rechten">Rechten</label>
			<select name="item_rechten" id="item_rechten">
				<option value="docent" <?php if($item_rechten == 'docent') echo 'selected'; ?>>docent</option>
		...
		<p><label for="item_geslacht">Geslacht</label><input type="radio" name="item_geslacht" value="man" <?php if($item_geslacht == 'man' ||  empty($item_geslacht)) echo 'checked'; ?> /> Man <input type="radio" name="item_geslacht" value="vrouw" <?php if($item_geslacht == 'vrouw') echo 'checked'; ?> /> Vrouw <span class="feedback"><?php echo $item_geslacht_feedback ?></span></p>
		...
		<p><label for="item_instelling_anoniem">Instelling anoniem</label><input type="radio" name="item_instelling_anoniem" value="ja" <?php if($item_instelling_anoniem == 'ja') echo 'checked'; ?> /> Ja <input type="radio" name="item_instelling_anoniem" value="nee" <?php if($item_instelling_anoniem == 'nee' || empty($item_instelling_anoniem)) echo 'checked'; ?> /> Nee <span class="feedback"><?php echo $item_instelling_anoniem_feedback ?></span></p>
		<p><label for="item_instelling_email_updates">Instelling e-mail updates</label><input type="radio" name="item_instelling_email_updates" value="ja" <?php if($item_instelling_email_updates == 'ja') echo 'checked'; ?> /> Ja <input type="radio" name="item_instelling_email_updates" value="nee" <?php if($item_instelling_email_updates == 'nee' || empty($item_instelling_email_updates)) echo 'checked'; ?> /> Nee <span class="feedback"><?php echo $item_instelling_email_updates_feedback ?></span></p>
		<p><label for="item_instelling_berichten_aan">Instelling berichten aan</label><input type="radio" name="item_instelling_berichten_aan" value="ja" <?php if($item_instelling_berichten_aan == 'ja' || empty($item_instelling_berichten_aan)) echo 'checked'; ?> /> Ja <input type="radio" name="item_instelling_berichten_aan" value="nee" <?php if($item_instelling_berichten_aan == 'nee') echo 'checked'; ?> /> Nee <span class="feedback"><?php echo $item_instelling_berichten_aan_feedback ?></span></p>
		...
		<p class="submit"><input type="submit" value="Docent <?php echo $actie ?>" /> <a href="<?php echo base_url('cms/docenten/'.$item_ID) ?>" title="Annuleren">Annuleren</a> <?php if($actie == 'wijzigen'): ?><a href="<?php echo base_url('cms/docenten/verwijderen/'.$item_ID) ?>" title="Verwijderen">Verwijderen</a><?php endif; ?></p>
	</form>
</div>