<h1>Welkomstmail wijzigen</h1>
<div id="toevoegen_wijzigen" class="formulier">
    <form method="post" action="<?php echo base_url('cms/'. $actie .'/welkomstmail/'.$item_ID); ?>">
        ...
        <div id="media">
            ...
            <div id="media_container">
                ...
                <div id="media_acties">
                    <p><a href="#koppelen" title="Media koppelen aan welkomstmail" class="koppelen" data-soort="media" data-welkomstmail="true">Media koppelen</a> | <a href="<?php echo base_url('cms/media/toevoegen') ?>" title="Media toevoegen aan mediabibliotheek (opent een nieuw tabblad / venster)" target="_blank">Media toevoegen</a></p>
                    <input type="hidden" name="item_media" id="item_media" value="<?php echo $item_media ?>" data-aantal="0" />
                </div>
            </div>
        </div>
        <p class="submit"><input type="submit" value="welkomstmail wijzigen" /><a href="<?php echo base_url('cms/'. $actie .'/wijzigen/'.$item_ID) ?>" title="Annuleren">Annuleren</a></p>
    </form>
</div>