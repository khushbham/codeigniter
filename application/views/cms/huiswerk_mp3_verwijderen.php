...
<div id="verwijderen">
	...
	<p><a href="<?php echo base_url('cms/huiswerk/verwijder_item/'. $huiswerk->huiswerk_ID .'/'.$item->resultaat_ID.'/ja') ?>" title="Ja, verwijderen">Ja</a> / <a href="<?php echo base_url('cms/huiswerk/beoordelen/'.$item->resultaat_ID) ?>" title="Nee, annuleren">Nee</a></p>
</div>